...
from models_attention import attach_attention_module
...
def make_inception_cbam(in_shape, classes, attention_module = 'cbam_block'):
    
    model = model = InceptionV3(input_shape=in_shape, classes=classes, attention_module=attention_module)
